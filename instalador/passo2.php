...
<html lang="pt_br">
	...
	<body>
		<div class="login instalador">
			...
			<h2>Agora, por favor, preencha as informações básicas para a operação do MailMarketing.</h2>
			<form action="passo2.php" method="post">
				...
				<div>
					<p class="mini-info">Preencha com o nome da pasta onde você enviou os arquivos do MailMarketing</p>
					<?php
				...
				<div>
					<p class="mini-info">Digite o nome da Empresa ou Instituição que usará o MailMarketing</p>
			...
			<div class="info">
				Para funcionamento correto do do MailMarketing, recomendamos que use, pelo menos, PHP 5.4 ou superior e é necessário que use um banco MySQL.<br/>
