...
<div class="wrap grupos">
	<!--Crud-->
	<h1>Configurações de MailMarketing</h1>
	<div class="area_crud">
		<div class="crud">
			<form method="post" action="configuracoes.php" id="formulario">
				...
				<input type="text" name="pasta"  id="pasta" placeholder="Pasta onde está instalado o MailMarketing" required="true" value="<?php echo  $cPasta ; ?>"/>
			...
			<form class="importar" id="formCSV">
				...
				<div class="instrucoes">
					...
					<p>
						...
						<p class="pre">rodrigo@matheusnattan.com;Rodrigo Alves;38 986xx-xxxx<br/>yanka@matheusnattan.com;Yanka;<br/>luciano@matheusnattan.com;;38 986xx-xxxx</p>
					</p>
					<p class="obs">
